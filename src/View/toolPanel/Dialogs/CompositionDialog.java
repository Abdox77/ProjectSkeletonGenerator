...
public class CompositionDialog extends JDialog {
    ...
    public CompositionDialog(Frame parent, List<String> classNames) {
        super(parent, "Create Composition", true);
