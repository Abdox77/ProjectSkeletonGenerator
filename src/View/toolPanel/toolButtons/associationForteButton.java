...
public class associationForteButton extends AtoolButton {
    private toolPanelObserver observer;
    private static final String ICON_NAME = "association_forte.png";
    private static final String MESSAGE_INFO = "Create a strong association";

    public associationForteButton(toolPanelObserver _observer) {
        ...
        addActionListener(e -> {
            ...
            AssociationDialog dialog = new AssociationDialog(parentFrame, classNames, "Create Strong Association");
            ...
            if (dialog.isConfirmed()) {
                ...
                observer.onAssociationForteCreate(firstClass, secondClass, cardFirstClass, cardSecondClass);
            }
        });
    }
}